    ...
    <form id="kt_modal_add_exchangerate_form" class="form" action="<?= base_url('exchangerate/edit') ?>" method="post" enctype="multipart/form-data">
        <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_exchangerate_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_exchangerate_header" data-kt-scroll-wrappers="#kt_modal_add_exchangerate_scroll" data-kt-scroll-offset="300px">
            ...
            <div class="d-flex flex-column mb-7 fv-row">
                ...
                <select name="curr_base" aria-label="Select an Curr Base" data-control="select2" data-placeholder="Select an Curr Base..." data-dropdown-parent="#kt_modal_add_exchangerate" class="form-select form-select-solid fw-bold">
            ...
            <div class="fv-row mb-7">
                <label class="required fw-semibold fs-6 mb-2">Rate Date</label>
                <input type="text" name="rate_date" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Rate Date" value="<?= date('d-m-Y') ?>" readonly />
            </div>
            <div class="fv-row mb-7">
                <label class="required fw-semibold fs-6 mb-2">Rate Time</label>
                <input type="text" name="rate_time" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Rate Time" value="<?= date('H:i') ?>" readonly />
            </div>
            <div class="fv-row mb-7">
