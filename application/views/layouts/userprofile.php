<?php $user = $this->users_model->get_user_by($this->session->userdata('user_id'));
$avatar = (!empty($user->picture)) ? base_url('assets/media/avatars/') . $user->picture : base_url('assets/media/avatars/blank.png'); ?>
<div class="">
    <div class="d-flex align-items-center" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-overflow="true" data-kt-menu-placement="top-start">
        ...
        <div class="d-flex flex-column align-items-start justify-content-center ms-3">
            ...
            <a href="#" class="text-gray-800 fs-7 fw-bold text-hover-primary"><?= $user->name ?></a>
        </div>
    </div>
    <!--end::User info-->
        ...
        <div class="menu-item px-3">
            <div class="menu-content d-flex align-items-center px-3">
                ...
                <div class="d-flex flex-column">
                    ...
                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?= $user->role_name ?></a>
                </div>
                <!--end::Username-->
            </div>
        </div>
