...
var KTExchangerate = function () {
    ...
    return {
        init: function () {
            modalEl = document.getElementById("kt_modal_add_exchangerate");
            if (!modalEl) return;
            formEl = modalEl.querySelector("#kt_modal_add_exchangerate_form");
            if (!formEl) return;
            ...
            const validator = FormValidation.formValidation(formEl, {
                fields: {
                    curr_foreign: {
                        validators: {
                            notEmpty: {
                                message: "Currency foreign is required"
                            }
                        }
                    },
                    curr_base: {
                        validators: {
                            notEmpty: {
                                message: "Currency base is required"
                            }
                        }
                    },
                    rate: {
