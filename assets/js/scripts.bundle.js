...
var KTAppSidebar = function() {
    ...
    return {
        init: function() {
            var i, r;
            n = document.querySelector("#kt_app_sidebar_toggle"), e = document.querySelector("#kt_app_sidebar_navs_wrappers"), t = document.querySelector("#kt_app_sidebar"), n && null !== (i = KTToggle.getInstance(n)) && (i.on("kt.toggle.change", (function() {
                t.classList.add("animating"), setTimeout((function() {
                    t.classList.remove("animating")
                }), 300)
            })), i.on("kt.toggle.changed", (function() {
                var e = new Date(Date.now() + 2592e6);
                KTCookie.set("sidebar_minimize_state", i.isEnabled() ? "on" : "off", {
                    expires: e
                })
            }))), e && (r = e.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(r, e) && e.scroll({
                top: KTUtil.getRelativeTopPosition(r, e),
                behavior: "smooth"
            })
        }
    }
